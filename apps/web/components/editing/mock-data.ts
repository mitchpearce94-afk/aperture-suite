  ...
  return [
    {
      ...
      reference_image_keys: Array.from({ length: 87 }, (_, i) => `ref/style1/img_${i}.jpg`),
    ...
    },
    {
      ...
      reference_image_keys: Array.from({ length: 52 }, (_, i) => `ref/style2/img_${i}.jpg`),
    ...
    },
    {
      ...
      reference_image_keys: Array.from({ length: 24 }, (_, i) => `ref/style3/img_${i}.jpg`),
