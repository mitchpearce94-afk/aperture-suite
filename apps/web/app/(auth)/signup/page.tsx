...
export default function SignupPage() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-slate-500 mb-8">No credit card required. 14-day free trial on all plans.</p>
      ...
      <div className="relative mb-6">
        ...
        <div className="relative flex justify-center">
          <span className="bg-[#0a0a14] px-3 text-[10px] uppercase tracking-wider text-slate-600">or sign up with email</span>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Pearce"
              required
              className="w-full px-4 py-2.5 text-sm bg-white/[0.04] border border-white/[0.08] rounded-lg text-slate-300 placeholder:text-slate-600 focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/20 transition-all"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <input
            name="businessName"
            type="text"
            placeholder="Your photography business (optional)"
            className="w-full px-4 py-2.5 text-sm bg-white/[0.04] border border-white/[0.08] rounded-lg text-slate-300 placeholder:text-slate-600 focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/20 transition-all"
          />
        </div>
